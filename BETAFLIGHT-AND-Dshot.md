...
- BLHeli pass-through does not work if FC is set to DSHOT. Must change output to OneShot to use the pass-through. Alao, some ESC that have a signal filter cap may not work until the cap is removed.
