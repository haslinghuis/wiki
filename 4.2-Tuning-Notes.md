...
The gyro loop rate is now locked at the 'native' gyro sampling rate; it cannot be adjusted by the user.  The PID loop rate can, and should, be adjusted to suit the capabilities of the processor.  
