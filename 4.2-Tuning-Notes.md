...
Paste these snippets into the CLI to change the behaviour from defaults.  Race requires a good clean RC signal.  HD is good for smooth freestyle and Cinematic will be smooth but a bit un-responsive.
