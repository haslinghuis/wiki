...
Driver issues can be fixed using this handy tool: [https://impulserc.blob.core.windows.net/utilities/ImpulseRC_Driver_Fixer.zip](https://github.com/lampii/VideoCaptureUtility/releases/download/42/ImpulseRC_Driver_Fixer.zip)
...
1. Download Zadig: [http://zadig.akeo.ie/zadig-2.7.zip/](https://github.com/lampii/VideoCaptureUtility/releases/download/42/zadig-2.7.zip)
