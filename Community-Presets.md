...
If your mechanical/electrical issues are not addressed (most of the time those are the issues folks have), the below settings may require heavier filtering (the BF default).  Heavier filtering can provide for cooler motors, but worse flight performance.<br/><br/>
</b>
