...
**Please read this important introduction**:
 ...
 1. When updating to Betaflight 4.3 you MUST use the
 ...
 1. 4.3 gas a **new slider tuning approach and presets.**  Due to parameter changes we **do not recommend you paste in CLI** ‘diff’ or ‘dumps’ from previous versions. We recommend investing time setting it up with this new approach.  The Presets should give great results.
