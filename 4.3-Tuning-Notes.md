...
**Please read these important introductory notes**:
 ...
 1. After updating to Betaflight 4.3, you MUST use the [**latest 10.8 Betaflight Configurator.**](https://github.com/betaflight/betaflight-configurator/releases/tag/10.8.0-RC3) Earlier 10.8 and 10.7 configurator versions **will not** work properly with 4.3.
