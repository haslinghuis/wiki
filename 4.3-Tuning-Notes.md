...
>**NOTE 4**: **Sliders are active by default!  The slider positions will over-ride any pasted-in PID or filter settings that they control.** Use the sliders to recreate your previous settings.  Or, before pasting PID values into CLI, disable the sliders in Configurator.  [See](4.3-Tuning-Notes#New-tuning-sliders).
