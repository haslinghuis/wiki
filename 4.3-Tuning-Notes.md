...
**Please read this important introduction**:
 ...
 1. F4 processors should run a 4k PID loop.  F411 users should use DShot300, not DShot600, and are blocked from an 8k PID loop.  Most should be overclocked to 120Mhz, some will only tolerate 108Mhz.
