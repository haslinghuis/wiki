...
Default value of 50 means that airmode will try to compensate at it's best till 50% saturation. 0 means always maximum stabilisation and 100 always limited. 0 is like version 2.3.3 and 2.3.4 and 100 would act same like pre 2.3.3 and like in 2.3.5.

'''set gyro_sync_denom''' = 1

For 2khz, set it = 4
 for 2.6khz, set it = 3
 for 4 khz, set it = 2 (iffy depending on ESCs)
 for 8 khz (not recommended) set it = 1 
