...
- If you are updating from pre-3.4, please read the [Betaflight 3.4 Tuning Notes](https://github.com/betaflight/betaflight/wiki/3.5-tuning-notes) because they apply to 3.5 also.
