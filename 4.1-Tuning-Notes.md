...
- [Feed forward interpolation](4.1-Tuning-Notes#FeedForward-Interpolation), to reduce the spiky nature of the feed forward signal
- [Feed forward boost](4.1-Tuning-Notes#FeedForward-Boost) to improve transient stick response and reduce overshoot
- [Feed forward limiting](4.1-Tuning-Notes#FFeedForward-Limiting), to stop overshoot with max rate outgoing moves 
