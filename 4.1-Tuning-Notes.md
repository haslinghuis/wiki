...
Betaflight 4.1 significantly improves default filters, PIDs and FeedForward capabilities, all of which help make your quad fly better than ever, out of the box.  And we have a new 10.6 configurator!
...
```
set ff_interpolation_sp = AVERAGED
```
